...
export function isNumber(value) {
  ...
  // return (String(value) !== 'NaN' && String(value) !== 'Infinity') && (typeof value === 'number' || typeof value === 'bigint');
}
...
export function isNumericString(value) {
  ...
  // return typeof value === 'string' && String(value) !== '' && String(Number(value)) !== 'NaN' && typeof value !== 'bigint' && !String(value).includes(".")
}
/**
...
export function hasDefinedType(object) {
  return Object.hasOwn(object, 'type') && Object(object).type !== undefined
}
