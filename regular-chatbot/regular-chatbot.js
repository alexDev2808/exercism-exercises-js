...
export function getURL(userInput) {
  return userInput.match(/[a-z0-9-]+(\.[a-z]+\.[a-z]+|\.[a-z]+)/gi)
}
...
export function niceToMeetYou(fullName) {        
  return `Nice to meet you, ${fullName.split(/, /g).reverse().join(" ").replace(/[a-z]+/gi, function(word) {
...
console.log(niceToMeetYou(str2));